...
namespace IziHardGames
{
	/// <summary>
	/// Client
	/// <see cref="https://www.nuget.org/packages/PreEmptive.Protection.Checks.Attributes/2.0.0"/> ??? обфускатор
	/// <see cref="http://www.columbia.edu/~fdc/sample.html"/>
	/// В данный момент используется <see cref="Proxy.PassThroughProxy"/> сервер. в <see cref="ProxyServerAdapted"/> <see cref="https://www.nuget.org/packages/PassThroughProxy/"/>
