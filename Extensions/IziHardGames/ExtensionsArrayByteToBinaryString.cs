...
namespace System
{
	...
	{
		/// <summary>
		/// <see cref="ExtensionUnmanaged.ToStringBinaryPerCharBitStreamLeftToRight{T}(T)"/>
		/// </summary>
		...
		/// <summary>
		/// <see cref="ExtensionUnmanaged.ToStringBinaryPerCharForHuman{T}(T)"/>
		/// </summary>
		...
		/// <summary>
		/// <see cref="ExtensionUnmanaged.ToStringBinaryPerCharForHumanSeparateByte{T}(T, char)"/>
		/// </summary>
		/// <param name="val"></param>
		...
		/// <summary>
		/// <see cref="ExtensionUnmanaged.ToStringBinaryPerCharForHumanSeparateQuad{T}(T, char)"/>
		/// </summary>
		/// <param name="val"></param>
		/// <param name="separator"></param>
		/// <returns></returns>
