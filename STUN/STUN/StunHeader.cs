...
namespace IziHardGames.STUN
{
    ...
    public class StunHeader
    {
        ...
        /// <see cref="MessageType.CLASS_INDICATION"/>
        /// </summary>
        ...
        public static byte[] GenerateHMACSHA1(string key, byte[] message)
        {
            ...
            byte[] hash;
            using (HMACSHA1 sha1 = new HMACSHA1(hashkey, false))
            {
        ...
        /// <see cref="https://www.iana.org/assignments/stun-parameters/stun-parameters.xhtml"/>
        /// </summary>
        ...
        public struct MessageType
        {
            ...
            /// <see cref="https://datatracker.ietf.org/doc/html/rfc5389#section-6"/>
            /// <see cref="EStunMethod"/>
            /// </summary>
